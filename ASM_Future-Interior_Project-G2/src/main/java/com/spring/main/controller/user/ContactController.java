...
public class ContactController {
	...
	// public String getContactPage(@ModelAttribute("lh") MailInfo lienhe, Model
	// model) {
	...
	// @RequestParam("attach") MultipartFile attach,@Valid @ModelAttribute("lienhe")
	// MailInfo lienhe, BindingResult result) {
